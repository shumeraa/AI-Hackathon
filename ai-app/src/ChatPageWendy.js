...
import Avatar from './assets/wilma.png';
...
function ChatPage() {
  ...
  const [messages, setMessages] = useState([
    { who: 'LLM', text: 'My names Wendy. Mind sharing any kind words?', audioSrc: null }
  ]);
      ...
      <div className="h-screen bg-primaryPurple text-white flex">
        ...
        <div className="mt-4 flex flex-col w-3/4 py-8 pl-4 pr-16 ">
          <div className="mx-auto flex-col items-center mb-6">
            ...
            />
            <div className="text-2xl">Wendy WIldfire</div>
          </div>
